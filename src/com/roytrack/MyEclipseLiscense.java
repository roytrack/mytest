...
public class MyEclipseLiscense {
	public static final void main(String[] args) {

		   String id = "rcm";///"改为你的注册ID";

		   String num = "22";//"改为 1-999 的整数";
		...
		public static String getSerial(String userId, String version,
		   ...
		   String dx = (new StringBuffer(String.valueOf(need)))
		     ...
		     .append(
		       ...
		       "Decompiling this copyrighted software is a violation of both your license agreement"+
		"and the Digital Millenium Copyright Act of 1998 (http://www.loc.gov/copyright/legislation/dmca.pdf)."+
		"Under section 1204 of the DMCA, penalties range up to a $500,000 fine or up to five years"+
		"imprisonment for a first offense. Think about it; pay for a license, avoid prosecution, and feel"+
		"better about yourself.") .append(userId).toString();
